...
while jogando:
    ...
    while True:
        ...
        if (linha_oponente, coluna_oponente) not in posicoes_oponente_atacadas:
            break

    posicoes_oponente_atacadas.append((linha_oponente, coluna_oponente))
